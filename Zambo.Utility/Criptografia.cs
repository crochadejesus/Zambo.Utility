...
namespace Zambo.Utility
{
	public sealed class Criptografia
	{
		...
		private static volatile Criptografia _Instance = null;
		...
		/// <summary>
		/// Verifica se a classe já foi instanciada ou não.
		/// Caso não tenha sido ainda, instancia, caso já tenha retorna o valor da instância.
		/// </summary>
		/// <returns></returns>
		public static Criptografia GetInstance()
		{
			if (_Instance == null)
			{
				lock (typeof(Criptografia))
				{
					if (_Instance == null)
						_Instance = new Criptografia();
				}
			}
			return _Instance;
		}
		...
		public string Encrypt(string clearText)
		{
			...
			string Password = string.Format("{0:ddMM}", DateTime.Now) + "102100";
		...
		public string EncryptSenha(string clearText)
		{

			string Password = "0ai%geK1";
			// First we need to turn the input string into a byte array.
		...
		public string DecryptSenha(string cipherText)
		{
